...
CREATE TABLE `t_chapitre` (
  `CHAP_ID` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
(12, 3, 'pampa', '2017-06-11 23:00:08', '<p style=\"text-align: left;\"><em>tralala 58</em></p>', 0);
...
INSERT INTO `t_commentaire` (`COM_ID`, `COM_AUTEUR`, `COM_DATE`, `COM_CONTENU`, `COM_SIGNALEMENT`, `CHAP_ID`) VALUES
(2, 'toto', '2017-06-10 18:29:06', 'test', 0, 23),
(3, 'test', '2017-06-11 14:12:25', 'test', 0, 31);
...
CREATE TABLE `t_utilisateur` (
  `UTIL_ID` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
